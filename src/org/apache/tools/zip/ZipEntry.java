...
public class ZipEntry extends java.util.zip.ZipEntry implements Cloneable
{
	 ...
	 * compression methods STORED and DEFLATED. We override the field so that
	 * any compression methods can be used.
	 * <p>
	 ...
	 * throws an IllegalArgumentException if the size is bigger than 2GB for
	 * Java versions < 7. Need to keep our own size information for Zip64
	 * support.
	 */
	private long size = -1;
	...
	/**
	 * Creates a new zip entry taking some information from the given file and
	...
	/**
	 * Returns the compression method of this entry, or -1 if the compression
	...
	/**
	 * Sets the name using the raw bytes and the string created from it by
	 * guessing or using the configured encoding.
	 * 
	 * @param name
	 *            the name to use created from the raw bytes using the guessed
	 *            or configured encoding
	 * @param rawName
	...
	public boolean equals(Object obj)
	{
		...
		return getTime() == other.getTime() && myComment.equals(otherComment)
				...
				&& getSize() == other.getSize() && getCrc() == other.getCrc() && getCompressedSize() == other.getCompressedSize()
