...
public class ZipFile
{
	 ...
	 */
	private final Map<String, LinkedList<ZipEntry>> nameMap = new HashMap<String, LinkedList<ZipEntry>>(HASH_SIZE);
	...
	/**
	 * Returns all named entries in the same order they appear within the
	 * archive's central directory.
	 * 
	 * @param name
	 *            name of the entry.
	...
	/**
	 * Returns all named entries in the same order their contents appear within
	 * the archive.
	 * 
	 * @param name
	 *            name of the entry.
	 ...
	 * </p>
	 * 
	 * @return a map of zipentries that didn't have the language encoding flag
	 *         set when read.
	 */
	...
	/**
	 * Reads an individual entry of the central directory, creats an ZipEntry
	 * from it and adds it to the global maps.
	 * 
	 * @param noUTF8Flag
	 *            map used to collect entries that don't have their UTF-8 flag
	 *            set and whose name will be set by data read from the local
	 *            file header later. The current entry may be added to this map.
	 */
	 ...
	 * from there if the entry's sizes are set to 0xFFFFFFFFF, do the same for
	...
	/**
	 * Length of the "End of central directory record" - which is supposed to be
	 * the last structure of the archive - without file comment.
	 */
	 ...
	 * directory entry inside the "End of central directory
	 * record" relative to the start of the "End of central directory record".
	 */
	 ...
	 * right in front of the "end of central directory record" if one is present
	 * at all.
	 */
	 ...
	 * directory record" inside the "Zip64 end of central directory
	 * locator" relative to the start of the "Zip64 end of central directory
	 * locator".
	 */
	...
	/**
	 * Offset of the field that holds the location of the first central
	 * directory entry inside the "Zip64 end of central directory
	 * record" relative to the start of the "Zip64 end of central directory
	 * record".
	 */
	 ...
	 * given signature, positions the RandomaccessFile right at the signature if
	 * it has been found.
	 */
	...
	/**
	 * Skips the given number of bytes or throws an EOFException if skipping
	 * failed.
	 */
