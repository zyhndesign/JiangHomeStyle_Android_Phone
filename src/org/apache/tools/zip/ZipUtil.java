...
public abstract class ZipUtil
{
	...
	/**
	 * Whether this library supports the compression method used by the given
	 * entry.
	 * 
	...
	/**
	 * Checks whether the entry requires features not (yet) supported by the
	 * library and throws an exception if it does.
	 */
